<?php
	...
	if (is_array($columns))
		...
		$word='';
	$sql="select a.account,a.name,b.caption as unit,c.caption as authority {$word}  from sys_account as a inner join sys_unit as b on a.unit=b.serial_id left join sys_authority as c on a.authority=c.serial_id ";
	$rs=$db->Execute($sql);
	if ($rs)
	{
